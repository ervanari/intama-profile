              ...
              <div className="container">
                <div className="row">
                  ...
                  <div className="col-12 col-md-6 text-center">
                    <h6 className="title-blue">" We are seeking people who wants to create real positive impacts and
                      build something meaningful for the world. "</h6><br />
                  </div>
                  <div className="col-3" />
                      ...
                      <Tab.Content>
                        <Tab.Pane eventKey="backend">
                          ...
                          <ul>
                            ...
                            <li>Understand the product, constantly optimise the product, identify and fix problems,
                              improve stability and user experience</li>
                            <li>Collaborate with fellow developers, product managers, user experience designer, and
                              operation engineers to build products with web technologies</li>
                          </ul>
                          <h6>Requirements:</h6>
                          <ul>
                            <li>Passionate about coding and programming, innovation, and solving challenging problems
                            </li>
                            <li>Hands-on experiences in Web Service frameworks and technologies such as Django, Ruby On
                              Rails, or Node.js</li>
                            <li>Familiar with performance tuning of Web Server, massive concurrency handling, and
                        ...
                        <Tab.Pane eventKey="frondend">
                          ...
                          <h6>Job Description:</h6>
                          <ul>
                            <li>Design and implement leading platform used and loved by hundreds of millions of users
                            </li>
                            <li>Implement solutions to complex and flexible business features</li>
                            <li>Maintain and improve our high-quality in-house JavaScript libraries and toolsets, for
                              example a complete React UI framework following our design guidelines</li>
                        ...
                        <Tab.Pane eventKey="ML">
                          ...
                          <ul>
                            ...
                            <li>Build high performance, high availability, scalability, and easy to maintain services
                            </li>
                            <li>Communicate with other team, deep understand data from different sources and product
                              architecture, optimise the data process pipeline</li>
                          ...
                          <ul>
                            ...
                            <li>Hands-on experience in at least one of the programming languages: Go, Python or C++,
                              less than 1 year of experience welcomed</li>
                            <li>Machine learning algorithms such as clustering, classification algorithms and data
                              processing tools such as tensorflow, scikit</li>
                            <li>Hands-on experience in distributed data platforms and processing frameworks such as
                              Hadoop, Spark, Map-Reduce</li>
                        ...
                        <Tab.Pane eventKey="QA">
                          ...
                          <h6>Job Description:</h6>
                          <ul>
                            <li>Write test scripts to automate complex test cases and scenarios for web and/or mobile
                              applications</li>
                            <li>Have experienced on doing performance testing such as stress and load tests</li>
                            <li>Ability to define test plan which include test scenarios and test cases based on
                              acceptance criteria</li>
                            <li>Execute all relevant testing types for the story, including user interface testing,
                              functionality testing, performance testing, regression testing, or integration testing
                            </li>
            ...
            <div className="foot-note">
              <div className="container">
                <div className="footer-content text-center d-lg-flex justify-content-between align-items-center">
                  <p className="mb-0 text-center" data-aos="fade-right" data-aos-offset={0}>© 2020 PT.INTAMA | All
                    Rights Reserved.</p>
                </div>
              </div>
            </div>
